...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://lens.docusign.net';
     ...
     * @var string
     */
    protected $userAgent = 'Swagger-Codegen/v2.0/1.2.1-rc1/php/' . PHP_VERSION;
    ...
    {
        $report  = 'PHP SDK (DocuSign\Monitor) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    OpenAPI Spec Version: v2.0' . PHP_EOL;
        $report .= '    SDK Package Version: 1.2.1-rc1' . PHP_EOL;

...
use DocuSign\Monitor\Client\Auth\OAuth;
...
class ApiClient
{
     ...
     *
     * @throws DocuSign\Monitor\Client\ApiException on a non 2xx response
     * @return mixed
     */
    ...
    public function generateAccessToken($client_id = null, $client_secret = null, $code = null)
    {
        ...
        return [$this->getSerializer()->deserialize($response, '\DocuSign\Monitor\Client\Auth\OAuthToken', $httpHeader), $statusCode, $httpHeader];
    }
    ...
    public function getUserInfo($access_token)
    {
        ...
        return [
            $this->getSerializer()->deserialize(
                $response,
                '\DocuSign\Monitor\Client\Auth\UserInfo',
                $httpHeader
            ),
            $statusCode,
            $httpHeader
